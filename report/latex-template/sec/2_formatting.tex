...
The third strategy implemented selective fine-tuning of ResNet50, where all convolutional layers remained frozen (requires_grad=False) while only the final classification layer underwent parameter updates. 
